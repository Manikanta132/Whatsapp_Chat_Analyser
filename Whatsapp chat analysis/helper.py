...
def fetch_stats(selected_user,df):
    ...
    if selected_user != 'Overall':
        df = df[df['user'] == selected_user] # dataframe gets changed if it is not overall
